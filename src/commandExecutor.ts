...
export class CommandExecutor {
    ...
    private _invoke(
        ...
        const onChildProcessEnd = (success: boolean) => success ? callback(childProcess.killed, undefined, result.stdout) : callback(childProcess.killed, result.errMsg);
        ...
        childProcess.on('exit', (code, _signal) => onChildProcessEnd(code === 0));
